...
.method protected parseDocument()Lorg/dom4j/Document;
    ...
    .line 366
    iget-object v3, p0, Lorg/dom4j/io/XPPReader;->xppFactory:Lorg/gjt/xpp/XmlPullParserFactory;

    invoke-virtual {v3}, Lorg/gjt/xpp/XmlPullParserFactory;->newEndTag()Lorg/gjt/xpp/XmlEndTag;
    ...
    .line 392
    :pswitch_1
    invoke-interface {v1, v3}, Lorg/gjt/xpp/XmlPullParser;->readEndTag(Lorg/gjt/xpp/XmlEndTag;)V
    ...
    .line 381
    invoke-interface {v4, v5}, Lorg/dom4j/Element;->add(Lorg/dom4j/Element;)V

    goto :goto_1

    .line 383
    :cond_2
    invoke-interface {v0, v5}, Lorg/dom4j/Document;->add(Lorg/dom4j/Element;)V
