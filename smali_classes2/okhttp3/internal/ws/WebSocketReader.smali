...
.method private readControlFrame()V
    ...
    invoke-interface {v0, v1, v4, v5}, Lokio/e;->a(Lokio/c;J)V
    ...
    invoke-static {v0, v1}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lokio/c$a;[B)V
    ...
    .line 193
    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:Lokio/c;
...
.method private readHeader()V
    ...
    invoke-interface {v2}, Lokio/e;->timeout()Lokio/s;

    move-result-object v2

    invoke-virtual {v2}, Lokio/s;->clearTimeout()Lokio/s;
    ...
    invoke-interface {v3}, Lokio/e;->timeout()Lokio/s;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lokio/s;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/s;
...
.method private readMessage()V
    ...
    invoke-virtual {v0, v5, v6}, Lokio/c$a;->a(J)I
