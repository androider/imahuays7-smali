...
.method constructor <init>(Landroid/arch/lifecycle/d;Landroid/arch/lifecycle/o;)V
    ...
    .param p1    # Landroid/arch/lifecycle/d;
        ...
        .end annotation
    .end param
    .param p2    # Landroid/arch/lifecycle/o;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    .line 360
    invoke-static {p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;->getInstance(Landroid/arch/lifecycle/o;)Landroid/support/v4/app/LoaderManagerImpl$LoaderViewModel;
...
.method private createAndInstallLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;Landroid/support/v4/content/Loader;)Landroid/support/v4/content/Loader;
    ...
    .line 383
    iget-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLifecycleOwner:Landroid/arch/lifecycle/d;

    invoke-virtual {v2, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->setCallback(Landroid/arch/lifecycle/d;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
    ...
    invoke-virtual {v0, p1, p3}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->setCallback(Landroid/arch/lifecycle/d;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
