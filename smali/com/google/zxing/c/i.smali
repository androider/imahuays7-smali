...
# instance fields
.field private final a:[Lcom/google/zxing/c/k;
...
.method public constructor <init>(Ljava/util/Map;)V
    ...
    invoke-direct {v3, p1}, Lcom/google/zxing/c/j;-><init>(Ljava/util/Map;)V
    ...
    invoke-direct {v3, v1}, Lcom/google/zxing/c/c;-><init>(Z)V
    ...
    .line 74
    new-instance v0, Lcom/google/zxing/c/a/a/d;

    invoke-direct {v0}, Lcom/google/zxing/c/a/a/d;-><init>()V
    ...
    invoke-direct {v0, p1}, Lcom/google/zxing/c/j;-><init>(Ljava/util/Map;)V

    invoke-interface {v2, v0}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 79
    new-instance p1, Lcom/google/zxing/c/c;

    invoke-direct {p1}, Lcom/google/zxing/c/c;-><init>()V

    invoke-interface {v2, p1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 80
    new-instance p1, Lcom/google/zxing/c/a;

    invoke-direct {p1}, Lcom/google/zxing/c/a;-><init>()V

    invoke-interface {v2, p1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 81
    new-instance p1, Lcom/google/zxing/c/d;

    invoke-direct {p1}, Lcom/google/zxing/c/d;-><init>()V

    invoke-interface {v2, p1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 82
    new-instance p1, Lcom/google/zxing/c/b;

    invoke-direct {p1}, Lcom/google/zxing/c/b;-><init>()V

    invoke-interface {v2, p1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 83
    new-instance p1, Lcom/google/zxing/c/h;

    invoke-direct {p1}, Lcom/google/zxing/c/h;-><init>()V

    invoke-interface {v2, p1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 84
    new-instance p1, Lcom/google/zxing/c/a/e;

    invoke-direct {p1}, Lcom/google/zxing/c/a/e;-><init>()V

    invoke-interface {v2, p1}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    .line 85
    new-instance p1, Lcom/google/zxing/c/a/a/d;

    invoke-direct {p1}, Lcom/google/zxing/c/a/a/d;-><init>()V
    ...
    new-array p1, p1, [Lcom/google/zxing/c/k;

    invoke-interface {v2, p1}, Ljava/util/Collection;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Lcom/google/zxing/c/k;

    iput-object p1, p0, Lcom/google/zxing/c/i;->a:[Lcom/google/zxing/c/k;
...
.method public a(ILcom/google/zxing/common/a;Ljava/util/Map;)Lcom/google/zxing/g;
    ...
    .line 94
    iget-object v0, p0, Lcom/google/zxing/c/i;->a:[Lcom/google/zxing/c/k;
    ...
    .line 96
    :try_start_0
    invoke-virtual {v3, p1, p2, p3}, Lcom/google/zxing/c/k;->a(ILcom/google/zxing/common/a;Ljava/util/Map;)Lcom/google/zxing/g;
