...
.method public static discard(Lokio/r;ILjava/util/concurrent/TimeUnit;)Z
    .locals 0

    .line 187
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/r;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static skipAll(Lokio/r;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v2}, Lokio/s;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lokio/s;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, v5, v6}, Lokio/s;->deadlineNanoTime(J)Lokio/s;
    ...
    .line 205
    invoke-interface {p0, p1, v5, v6}, Lokio/r;->read(Lokio/c;J)J
    ...
    invoke-virtual {p0}, Lokio/s;->clearDeadline()Lokio/s;
    ...
    invoke-virtual {p0, v2, v3}, Lokio/s;->deadlineNanoTime(J)Lokio/s;
